...
echo "preparing petclinic.conf configuration for serving static files ..."
server_config=$(cat resources/petclinic.conf)    
...
environment_ts="export const environment = {\n
  production: true,\n
  REST_API_URL: 'http://${back_a[1]}:${back_a[2]}/petclinic/api/'\n
};"
